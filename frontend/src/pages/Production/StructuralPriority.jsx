...
export default function StructuralPriority() {
  ...
  const moduleType = 'STRUCTURAL';
  const tabs = ["PEDDINGHAUS DRILL LINE", "FICEP", "PUNCH"];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Structural Priority</h2>
